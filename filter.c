...
* @param byWhat 按照什么来过滤
* @param whichProperty 在结构体中的过滤属性是什么
* @param whichExternFlag 哪个extern变量存储比较值
* @param equalMacro 比较宏，定义两值相等关系是什么
*/
